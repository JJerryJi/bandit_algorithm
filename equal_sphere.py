...
def find_partition(num_sector, n_features):
...
def generate_action_sets(step_size, num_partitions, n_features, n_arm):
    ...
    for i in range(num_partitions):
        ...
        add_idx = None
        for k in range(0, len(count_table)):
...
# n_arm = 2
# num_sector = 100
# step, num_partitions = find_partition(num_sector, n_features)
# action_sets = generate_action_sets(step, num_partitions, n_features, n_arm)
